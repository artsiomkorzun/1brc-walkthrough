...
CLASS_NAME=dev.morling.onebrc.CalculateAverage_artsiomkorzun_nosharing
IMAGE_NAME=build/image-artsiomkorzun-nosharing
...
$TASKSET $HYPERFINE "$IMAGE_NAME" $HYPERFINE_OPTS