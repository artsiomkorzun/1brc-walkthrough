...
public class Challenge_12_BetterHash implements Challenge {
    ...
    public static void main(String[] args) {
        new Challenge_12_BetterHash().run(args);
    }
    ...
    static class Aggregates { // keys <= 10K, no need to grow
        ...
        Entry put(long position, int length, long hash, long tail) {
            ...
            for (int mask = entries.length - 1, index = (int) hash & mask; ; index = (index + 1) & mask) {
